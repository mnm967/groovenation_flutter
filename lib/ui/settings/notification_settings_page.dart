          ...
          children: [
            DropdownButton<String>(
              ...
              onChanged: (String? newValue) {
                setState(() {
                  if (newValue == NOTIFICATION_ALL_NEARBY_OPTION)
                    dropdownValue = NOTIFICATION_ALL_NEARBY;
                  else if (newValue == NOTIFICATION_FAVOURITE_ONLY_OPTION)
                    dropdownValue = NOTIFICATION_FAVOURITE_ONLY;
                  else
                    dropdownValue = NOTIFICATION_OFF;
                });
